...
const TaskSchema = Type.Object({
  ...
  cwd: Type.Optional(Type.String({ description: "Task working directory. Use an explicit absolute path for an external repository; relative paths must stay inside the parent workspace. Paths mentioned only in task prose do not change cwd." })),
...
const SubagentParameters = Type.Object({
  ...
  cwd: Type.Optional(Type.String({ description: "Working directory override. Use an explicit absolute path for an external repository; relative paths must remain inside the parent workspace. Task prose does not change cwd." })),
